...
import os
from config import conferences_synonyms, journals_synonyms, projects_synonyms, resources_path
...
def main():
    ...
    write_dict(projects_synonyms, resources_path + 'synonyms' + os.sep + 'projects_synonyms')
