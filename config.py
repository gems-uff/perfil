...
# The directory that contains the .xlsx files generated by full_professorship_advancement.py script.
full_professorship_advancement_output_dir = os.getcwd() + os.sep + 'full_professorship_advancement'
if not os.path.exists(full_professorship_advancement_output_dir):
    os.makedirs(full_professorship_advancement_output_dir)
